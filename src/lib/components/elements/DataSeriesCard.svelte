...
<div>
	...
	{#if columnMetaData.column_avg !== null}
		<p>Average: {columnMetaData.column_avg}</p>
	{/if}
	{#if columnMetaData.column_max !== null}
		<p>Minimum: {columnMetaData.column_max}</p>
	{/if}
	{#if columnMetaData.column_min !== null}
